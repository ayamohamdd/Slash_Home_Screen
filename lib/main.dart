...
import 'package:flutter_application_8/features/home/presentation/views/home_screen.dart';
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        ...
        BlocProvider(
          create: (context) => FetchNewArrivalProductsCubit(FetchNewArrivalProductsUseCase(     homeRepo: HomeRepoImpl(homeDataSource: HomeDataSourceImpl())),
         )..fetchNewArrivalProducts()
        ),
        BlocProvider(
          create: (context) => FetchRecommendedProductsCubit(FetchRecommendedProductsUseCase(     homeRepo: HomeRepoImpl(homeDataSource: HomeDataSourceImpl())),
         )..fetchRecommendedProducts()
        ),
        BlocProvider(
          create: (context) => FetchCategoryCubit(FetchCategoriesUseCase(homeRepo: HomeRepoImpl(homeDataSource: HomeDataSourceImpl())),
         )..fetchCategory()
        ),
      ],
      child: MaterialApp(
